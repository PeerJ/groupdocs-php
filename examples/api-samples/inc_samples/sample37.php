...
//###<i>This sample will show how to Create and Upload Envelop to GroupDocs account and get signed document using PHP SDK </i>
...
if (empty($clientId) || empty($privateKey)) {
    ...
    if ($file["name"] != "") {
        ...
        if (null === $uploadedFile) {
            return new RedirectResponse("/sample37");
        }
...
echo Template::serve('sample37.htm');